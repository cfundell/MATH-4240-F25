...
int main(int argc, char* argv[]) {
    ...
    double wall_time = time_end - time_start;
...
double AdaptiveIntSerial(const double a, const double b, const double TOL, char* filename) {
    ...
    fclose(file);
    const double one_over_15 = 6.66666666666667e-02;
...
double Q(const double a, const double b) { 
    double f(const double x);
    const double one_sixth = 1.6666666666666667e-01;
    const double c = 0.5*(a + b);
